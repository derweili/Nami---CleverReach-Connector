...
class NamiConnector{ 
	...
	function __construct( $https, $url ) {
            $this->https = $https;
			$this->url = $url;
			$this->Login = "API";
            //$this->username = $credentials["username"]"78175"; // NamiNumber
            //$this->password = $credentials["password"];
            $this->curlOptions = array("CURLOPT_COOKIEJAR" => COOKIE_PATH ,"CURLOPT_COOKIEFILE" => COOKIE_PATH);
			//$this->curlOptions = array("CURLOPT_COOKIEJAR" => "/www/htdocs/w00f0942/tmp/cookie.txt" ,"CURLOPT_COOKIEFILE" => "/www/htdocs/w00f0942/tmp/cookie.txt");

			//$this->gid = $this->get_groupid();
			$this->gid = "070901";
    }
